<?php
namespace ParadoxLabs\Authnetcim\Model\Config\Version;

/**
 * Interceptor class for @see \ParadoxLabs\Authnetcim\Model\Config\Version
 */
class Interceptor extends \ParadoxLabs\Authnetcim\Model\Config\Version implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Model\Context $context, \Magento\Framework\Registry $registry, \Magento\Framework\App\Config\ScopeConfigInterface $config, \Magento\Framework\App\Cache\TypeListInterface $cacheTypeList, \Magento\Framework\Module\Dir $moduleDir, \Magento\Framework\Filesystem\Io\File $fileHandler, \Magento\Framework\Model\ResourceModel\AbstractResource $resource = null, \Magento\Framework\Data\Collection\AbstractDb $resourceCollection = null, array $data = array())
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $moduleDir, $fileHandler, $resource, $resourceCollection, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getDefaultValue');
        if (!$pluginInfo) {
            return parent::_getDefaultValue();
        } else {
            return $this->___callPlugins('_getDefaultValue', func_get_args(), $pluginInfo);
        }
    }
