...
class Interceptor extends \Webkul\AdvancedLayeredNavigation\Block\FilterRenderer implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSessionData');
        if (!$pluginInfo) {
            return parent::getSessionData($data);
        } else {
            return $this->___callPlugins('getSessionData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMinVal');
        if (!$pluginInfo) {
            return parent::getMinVal($id);
        } else {
            return $this->___callPlugins('getMinVal', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setMinVal');
        if (!$pluginInfo) {
            return parent::setMinVal($val, $id);
        } else {
            return $this->___callPlugins('setMinVal', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setMaxVal');
        if (!$pluginInfo) {
            return parent::setMaxVal($val, $id);
        } else {
            return $this->___callPlugins('setMaxVal', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMaxVal');
        if (!$pluginInfo) {
            return parent::getMaxVal($id);
        } else {
            return $this->___callPlugins('getMaxVal', func_get_args(), $pluginInfo);
        }
    }
