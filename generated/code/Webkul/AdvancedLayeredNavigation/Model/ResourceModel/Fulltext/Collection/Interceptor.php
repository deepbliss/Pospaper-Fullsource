<?php
namespace Webkul\AdvancedLayeredNavigation\Model\ResourceModel\Fulltext\Collection;

/**
 * Interceptor class for @see \Webkul\AdvancedLayeredNavigation\Model\ResourceModel\Fulltext\Collection
 */
class Interceptor extends \Webkul\AdvancedLayeredNavigation\Model\ResourceModel\Fulltext\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddedFilters');
        if (!$pluginInfo) {
            return parent::getAddedFilters();
        } else {
            return $this->___callPlugins('getAddedFilters', func_get_args(), $pluginInfo);
        }
    }
