<?php
namespace Webkul\AdvancedLayeredNavigation\Model\Layer\Category;

/**
 * Interceptor class for @see \Webkul\AdvancedLayeredNavigation\Model\Layer\Category
 */
class Interceptor extends \Webkul\AdvancedLayeredNavigation\Model\Layer\Category implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCollectionProvider');
        if (!$pluginInfo) {
            return parent::getCollectionProvider();
        } else {
            return $this->___callPlugins('getCollectionProvider', func_get_args(), $pluginInfo);
        }
    }
