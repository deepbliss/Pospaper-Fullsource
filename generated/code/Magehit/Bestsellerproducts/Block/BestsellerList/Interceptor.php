...
class Interceptor extends \Magehit\Bestsellerproducts\Block\BestsellerList implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSectionStatus');
        if (!$pluginInfo) {
            return parent::getSectionStatus();
        } else {
            return $this->___callPlugins('getSectionStatus', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVerticalStatus');
        if (!$pluginInfo) {
            return parent::getVerticalStatus();
        } else {
            return $this->___callPlugins('getVerticalStatus', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSlideAuto');
        if (!$pluginInfo) {
            return parent::getSlideAuto();
        } else {
            return $this->___callPlugins('getSlideAuto', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPagination');
        if (!$pluginInfo) {
            return parent::getPagination();
        } else {
            return $this->___callPlugins('getPagination', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNavigation');
        if (!$pluginInfo) {
            return parent::getNavigation();
        } else {
            return $this->___callPlugins('getNavigation', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSortbyCollection');
        if (!$pluginInfo) {
            return parent::getSortbyCollection();
        } else {
            return $this->___callPlugins('getSortbyCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStartDate');
        if (!$pluginInfo) {
            return parent::getStartDate();
        } else {
            return $this->___callPlugins('getStartDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEndDate');
        if (!$pluginInfo) {
            return parent::getEndDate();
        } else {
            return $this->___callPlugins('getEndDate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVisibleStatus');
        if (!$pluginInfo) {
            return parent::getVisibleStatus();
        } else {
            return $this->___callPlugins('getVisibleStatus', func_get_args(), $pluginInfo);
        }
    }
