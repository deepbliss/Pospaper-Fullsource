...
class Interceptor extends \Magento\AdminNotification\Block\ToolbarEntry implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getNotificationDescriptionLength()
    {
        ...
        if (!$pluginInfo) {
            return parent::getNotificationDescriptionLength();
        } else {
            return $this->___callPlugins('getNotificationDescriptionLength', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getNotificationCounterMax()
    {
        ...
        if (!$pluginInfo) {
            return parent::getNotificationCounterMax();
        } else {
            return $this->___callPlugins('getNotificationCounterMax', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getUnreadNotificationCount()
    {
        ...
        if (!$pluginInfo) {
            return parent::getUnreadNotificationCount();
        } else {
            return $this->___callPlugins('getUnreadNotificationCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getLatestUnreadNotifications()
    {
        ...
        if (!$pluginInfo) {
            return parent::getLatestUnreadNotifications();
        } else {
            return $this->___callPlugins('getLatestUnreadNotifications', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function formatNotificationDate($dateString)
    {
        ...
        if (!$pluginInfo) {
            return parent::formatNotificationDate($dateString);
        } else {
            return $this->___callPlugins('formatNotificationDate', func_get_args(), $pluginInfo);
        }
    }
