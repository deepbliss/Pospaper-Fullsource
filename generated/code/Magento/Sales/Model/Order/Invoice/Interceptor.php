...
class Interceptor extends \Magento\Sales\Model\Order\Invoice implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function wasPayCalled()
    {
        ...
        if (!$pluginInfo) {
            return parent::wasPayCalled();
        } else {
            return $this->___callPlugins('wasPayCalled', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCanVoidFlag()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCanVoidFlag();
        } else {
            return $this->___callPlugins('getCanVoidFlag', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getIsUsedForRefund()
    {
        ...
        if (!$pluginInfo) {
            return parent::getIsUsedForRefund();
        } else {
            return $this->___callPlugins('getIsUsedForRefund', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setTotalQty($qty)
    {
        ...
        if (!$pluginInfo) {
            return parent::setTotalQty($qty);
        } else {
            return $this->___callPlugins('setTotalQty', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setIsUsedForRefund($isUsedForRefund)
    {
        ...
        if (!$pluginInfo) {
            return parent::setIsUsedForRefund($isUsedForRefund);
        } else {
            return $this->___callPlugins('setIsUsedForRefund', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setCanVoidFlag($canVoidFlag)
    {
        ...
        if (!$pluginInfo) {
            return parent::setCanVoidFlag($canVoidFlag);
        } else {
            return $this->___callPlugins('setCanVoidFlag', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setBaseTotalRefunded($amount)
    {
        ...
        if (!$pluginInfo) {
            return parent::setBaseTotalRefunded($amount);
        } else {
